...
tl1.from('#bag', 1, { delay:0.5, ease: Back.easeOut.config(1.7), y: 400}, {opacity:0})
.to('#bag', 1.5, { delay: 1, ease: Back.easeOut.config(0.2), y: 500})
.staggerFrom("#new", 0.5, {scale:0.5, opacity:0, ease: Elastic.easeOut});



tl1.from('#premium', 1, {delay: -1.5, ease: Back.easeOut.config(1), x: -300})
.from('#chocolates', 1, {delay: -1.5, ease: Back.easeOut.config(1), x: 300})
.to('#premium', 1, { delay: 1, ease: Back.easeOut.config(0.2), x: -300})
